...
export const site: SiteConfig = {
  ...
  shortName: "SDRC",
  logo: `${import.meta.env.BASE_URL}img/SDRC_Logo-black.png`,
  ...
  groups: [
    {
      ...
      people: [
        { name: "Zack Gilman", role: "Lead Pastor", photo: `${import.meta.env.BASE_URL}img/PastorZackGilman.jpeg`, bio: "Zack is primarily responsible for preaching and vision at SDRC." },
